...
/**
 * check99 - checks that file_from exists and can be read
 * @check: checks if true of false
 * @file: file_from name
 * @fd_from: file descripation of file_from, or -1
 * @fd_to: file descripation of file_to, or -1
 * Return: void
 */
...
/**
 * check100 - checks that file descripation werw clodes property
 * @check: checks if true or false
 * @fd: file descripation
 * Return: void
 */
...
if (check == -1)
{
dprintf(STDERR_FILENO, "Eroor: Can't close fd %d\n", fd);
exit(100);
}
}
/**
